...
- **เลขหน้า (แผ่นที่ X / Y) ทุกแผ่น** (`@page` counter) + จัดเนื้อหาไหลเต็มหน้า (เอา break-avoid จาก section · เดิมหน้าแรกเหลือช่องว่างล่าง) · ทดสอบหลาย scenario (เดี่ยว pass/warn/fail · ต่อเนื่อง 2-3 ช่วง) 2 โหมดเหมือนกัน
- **กราฟแรงเฉือน (SFD) โชว์ค่า max + ตำแหน่ง** (จุด+ป้ายค่า peak V บวก/ลบ · เดิมไม่มีค่า/สเกล เหมือนกราฟโมเมนต์) · ทั้ง 2 โหมด · **ตำแหน่งกริดในเอกสารพิมพ์ดึงจากกริดในรูป** (`ccModel.grid` → A–B / A–B–C–D · เดิมใช้ headerStr อาจว่าง)
